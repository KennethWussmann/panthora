...
To configure the desired provider, refer to the [configuration guide](./configuration#authentication).

## Password Auth

<Callout type="warning">
  Using password auth is highly discouraged! Use [SSO](./authentication#sso)
  instead.
</Callout>
...
The password authentication mechanism is protected by rate-limiting to avoid enumeration, brute-force attacks and spam. Read more about rate-limiting in the corresponding [guide](./rate-limit).
