...
![](./assets/asset-type-edit-basic-explanation-upper.png)

<Steps>
  ### Step 1 Specify the parent asset type for inheritance, as detailed in the{" "}
  <a href="#inheritance">Inheritance section</a>. ### Step 2 Name of the asset
  type.
</Steps>
...
![](./assets/asset-type-edit-basic-explanation-lower.png)
